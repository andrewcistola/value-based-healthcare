...
title = "Finding Value: Factors Associated with Hospital Payment Adjustments from CMS for FY2020 (New York)"
author = "DrewC!"
...
df_raw = df_raw[df_raw["State"] == "NY"] # Susbet numeric column by condition
...
degree = len(X_i.index) - 1  # Save number of features -1 to get degrees of freedom
