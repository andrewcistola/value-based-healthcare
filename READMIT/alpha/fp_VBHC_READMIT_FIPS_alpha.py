...
### Outcome 
#### CMS Hospital Wide Readmission Rate 2018 
### Predictors
#### Selected Predictors
### Table Key
#### State County FIPS
...
features = ["Medicare hospital spending per patient (Medicare Spending per Beneficiary)", 
...
df_out = df_join.rename(columns = {"Rate of readmission after discharge from hospital (hospital-wide)": "outcome"}) # Rename multiple columns in place
