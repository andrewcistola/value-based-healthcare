...
### Predictors
#### ACS 2014-2018 Zip Code Percent Estimates for 50 States, Gini index and Average by County
### Table Key
#### Facility ID

title = "fp_VBHC_MSPB_ACS_FIPS_alpha"
path = "fp/VBHC/MSPB/"
...
df_pc_gini_reg.to_csv(r"fp/VBHC/MSPB/fp_VBHC_MSPB_ACS_FIPS_alpha.csv") # Export df as csv
