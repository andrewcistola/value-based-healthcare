...
### Predictors
#### CMS Hospital Compare 2018
### Table Key
#### Facility ID

title = "fp_VBHC_MSPB_CMS_FacilityID_alpha"
path = "fp/VBHC/MSPB"
...
### Drop ID variables
df_man = df_step1.drop(columns = ["FIPS", "Facility ID"]) # Drop Unwanted Columns

### Drop proximity variables
df_man = df_man.drop(columns = ["2018 VBP Adjustment Factor", "2019 VBP Adjustment Factor", "2020 VBP Adjustment Factor"]) # Drop Unwanted Columns
...
df_pc_gini_reg.to_csv(r"fp/VBHC/MSPB/fp_VBHC_MSPB_CMS_FacilityID_alpha.csv") # Export df as csv
