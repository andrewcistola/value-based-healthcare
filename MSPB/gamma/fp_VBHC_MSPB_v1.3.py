...
df_s1 = df_s1.rename(columns = {"Medicare hospital spending per patient (Medicare Spending per Beneficiary)": "quant"}) # Rename multiple columns in place
...
df_final.to_csv(r"fp/VBHC/v1.3/fp_VBHC_MSPB_v1.3.csv") # Export df as csv
print(df_final)
